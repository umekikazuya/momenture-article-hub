...
func TestPostgresArticleRepository_Update_ChangeStatus(t *testing.T) {
	...
	// ステータスが更新されていること
	assert.Equal(t, "published", foundArticle.Status.String(), "Status should be updated to 'published'")
	// タイトルが更新されていること
